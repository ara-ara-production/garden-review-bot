import{x,J as g,r as c,j as e}from"./app-lTXa_amd.js";import{H as h}from"./Head-BB09DokN.js";import{N as j}from"./NavBar-DIwVyvHr.js";import{C as b,R as y,a as s,B as v}from"./Alert-CfhHhM0J.js";import{F as C,a as f}from"./Label-BYIQ53rq.js";import{a as d,R as l}from"./RowFormGroupSelect-Cxdb2ocu.js";import"./Progress-CR1btosj.js";import"./FormFeedback-BQkV2uZ7.js";import"./Input-DCmDpdy8.js";const E=({values:a,users:i})=>{console.log(a);const{data:o,setData:n,put:_,processing:m,errors:t}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",yandex_map_id:a.yandex_map_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:p}=g().props,[w,N]=c.useState(!1),u=r=>{r.preventDefault(),_(`/${p.backendprefix}/${p.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(y,{children:e.jsx(s,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:u,children:[e.jsxs(s,{className:`
                        border
                        border-primary
                        rounded
                        col-12
