import{x as b,J as v,r as C,j as e}from"./app-ugDlbNq4.js";import{H as y}from"./Head-CLh9Vqvb.js";import{N as f}from"./NavBar-CnN1njMT.js";import{C as w,R as N,a as s,B as c}from"./Alert-AKsgNnkf.js";import{F,a as x}from"./Label-CfP9qrJV.js";import{R as t,a as _}from"./RowFormGroupSelect-DThagaic.js";import"./Progress-B9jOdwBG.js";import"./FormFeedback-D5neozbZ.js";import"./Input-DKilhvFA.js";const E=({users:i})=>{var u,m;const{data:a,setData:n,post:g,processing:l,errors:o}=b({name:"",user_id:(u=i[0])==null?void 0:u.name,two_gis_id:"",yandex_vendor_id:"",google_map_id:"",pupr_user_id:(m=i[0])==null?void 0:m.name,address:""}),{routes:d}=v().props,[h,p]=C.useState(!1),j=r=>{r.preventDefault(),g(`/${d.backendprefix}/${d.brunch}`+(h?"?redirectOnCreation=true":""))};return e.jsxs(e.Fragment,{children:[e.jsx(y,{title:"Создание филиала"}),e.jsx(f,{}),e.jsxs(w,{children:[e.jsx(N,{children:e.jsx(s,{children:e.jsx("h2",{children:"Cоздание филиала"})})}),e.jsxs(F,{className:"row",onSubmit:j,children:[e.jsxs(s,{className:`
                        ...
                        pl-0
                        pt-4
                        `,children:e.jsx(x,{children:e.jsx(c,{className:"w-100",type:"submit",value:"Сохранить и создать еще",color:"primary",outline:!0,disabled:l,onClick:()=>p(!0),children:"Сохранить и создать еще"})})})]})]})]})};export{E as default};
