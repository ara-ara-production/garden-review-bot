import{x,J as g,r as c,j as e}from"./app-ugDlbNq4.js";import{H as h}from"./Head-CLh9Vqvb.js";import{N as j}from"./NavBar-CnN1njMT.js";import{C as b,R as v,a as d,B as y}from"./Alert-AKsgNnkf.js";import{F as C,a as f}from"./Label-CfP9qrJV.js";import{R as s,a as l}from"./RowFormGroupSelect-DThagaic.js";import"./Progress-B9jOdwBG.js";import"./FormFeedback-D5neozbZ.js";import"./Input-DKilhvFA.js";const E=({values:a,users:i})=>{const{data:o,setData:n,put:u,processing:m,errors:t}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:p}=g().props,[w,N]=c.useState(!1),_=r=>{r.preventDefault(),u(`/${p.backendprefix}/${p.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(v,{children:e.jsx(d,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:_,children:[e.jsxs(d,{className:`
                        border
                        border-primary
                        rounded
                        col-12
