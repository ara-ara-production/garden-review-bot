import{x,J as h,r as j,j as e}from"./app-BcHd4eWn.js";import{H as f}from"./Head-_xtiLubh.js";import{N as g}from"./NavBar-jo5iGGA3.js";import{C as b,R as w,a as t,B as v}from"./Alert-CWZpn_r8.js";import{F as C,a as R}from"./Label-sRUBmtYk.js";import{R as l}from"./RowFormGroup-BZ4921Nw.js";import{R as y}from"./RowFormGroupWithPrefix-CQhD46BJ.js";import{R as N}from"./RowFormGroupSelect-D7y3-bLI.js";import"./Progress-CUABgi0U.js";const E=({values:n,roles:i})=>{const{data:a,setData:o,put:p,processing:u,errors:s}=x({name:n.name??"",telegram_username:n.telegram_username??"",email:n.email??"",password:"",password_confirmation:"",role:n.role??"NullRole"}),{routes:m}=h().props,[_,d]=j.useState(!1),c=r=>{r.preventDefault(),p(`/${m.backendprefix}/${m.user}/${n.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Обновление пользователя"}),e.jsx(g,{}),e.jsxs(b,{children:[e.jsx(w,{children:e.jsx(t,{children:e.jsx("h2",{children:"Обновление пользователя"})})}),e.jsxs(C,{className:"row",onSubmit:c,children:[e.jsxs(t,{className:`
                        border
                        border-primary
                        rounded
                        col-12
                        ...
                        pl-0
                        pt-4
                        `,children:e.jsx(R,{children:e.jsx(v,{className:"w-100",type:"submit",value:"Обновить",color:"primary",outline:!0,disabled:u,onClick:()=>d(!1),children:"Обновить"})})})]})]})]})};export{E as default};
