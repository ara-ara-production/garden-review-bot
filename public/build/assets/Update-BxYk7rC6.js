import{x,J as h,r as j,j as e}from"./app-OKPT5S3I.js";import{H as g}from"./Head-DgijFEdU.js";import{N as b}from"./NavBar-CGYac7tT.js";import{C as _,R as f,a as l,B as v}from"./Alert-DxwqOTkg.js";import{F as w,a as C}from"./Label-DESziUAu.js";import{a as n,R as y}from"./RowFormGroupSelect-gL5C4VOS.js";import{R as N}from"./RowFormGroupWithPrefix-DCr9tCya.js";import"./Progress-COrKAHbf.js";import"./FormFeedback-CFSrCRjM.js";import"./Input-C-6XNG1z.js";const H=({values:t,roles:m})=>{const{data:a,setData:o,put:p,processing:u,errors:s}=x({name:t.name??"",telegram_username:t.telegram_username??"",vk_user_id:t.vk_user_id??"",email:t.email??"",password:"",password_confirmation:"",role:t.role??"NullRole"}),{routes:i}=h().props,[R,d]=j.useState(!1),c=r=>{r.preventDefault(),p(`/${i.backendprefix}/${i.user}/${t.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(g,{title:"Обновление пользователя"}),e.jsx(b,{}),e.jsxs(_,{children:[e.jsx(f,{children:e.jsx(l,{children:e.jsx("h2",{children:"Обновление пользователя"})})}),e.jsxs(w,{className:"row",onSubmit:c,children:[e.jsxs(l,{className:`
                        border
                        border-primary
                        rounded
                        col-12
