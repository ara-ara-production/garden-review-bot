import{x as u,J as x,r as h,j as r}from"./app-DfVTecIs.js";import{H as j}from"./Head-DX95bVhR.js";import{N as b}from"./NavBar-D8sRQfmC.js";import{C as _,R as g}from"./Row-D6qjDry_.js";import{C as o,B as f}from"./Alert-Cn5ir1qf.js";import{F as w,a as C}from"./Label-BQvcVMvc.js";import{R as l,a as N}from"./RowFormGroupSelect-D9-uDwpU.js";const D=({values:s,users:m})=>{const{data:t,setData:n,put:d,processing:p,errors:a}=u({name:s.name??"",user_id:s.user_id??"",two_gis_id:s.two_gis_id??""}),{routes:i}=x().props,[v,y]=h.useState(!1),c=e=>{e.preventDefault(),d(`/${i.backendprefix}/${i.brunch}/${s.id}`)};return r.jsxs(r.Fragment,{children:[r.jsx(j,{title:"Обновление филиала"}),r.jsx(b,{}),r.jsxs(_,{children:[r.jsx(g,{children:r.jsx(o,{children:r.jsx("h2",{children:"Обновление филиала"})})}),r.jsxs(w,{className:"row",onSubmit:c,children:[r.jsxs(o,{className:`
                        border
                        border-primary
                        rounded
                        col-12
