import{x as b,J as f,r as g,j as e}from"./app-BcHd4eWn.js";import{H as w}from"./Head-_xtiLubh.js";import{N as v}from"./NavBar-jo5iGGA3.js";import{C,R as y,a as n,B as u}from"./Alert-CWZpn_r8.js";import{F as N,a as c}from"./Label-sRUBmtYk.js";import{R as t}from"./RowFormGroup-BZ4921Nw.js";import{R}from"./RowFormGroupWithPrefix-CQhD46BJ.js";import{R as _}from"./RowFormGroupSelect-D7y3-bLI.js";import"./Progress-CUABgi0U.js";const E=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:m}=f().props,[i,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${m.backendprefix}/${m.user}`+(i?"?redirectOnCreation=true":"")),i&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
