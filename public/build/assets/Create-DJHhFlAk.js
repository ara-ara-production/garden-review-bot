import{x as g,J as C,r as v,j as e}from"./app-7Pv2RsOj.js";import{H as f}from"./Head-BBRKqPB5.js";import{N as w}from"./NavBar-D3s3JYkU.js";import{C as N,R as y,a,B as u}from"./Alert-Cq83UR96.js";import{F,a as c}from"./Label-C2wOA9Ez.js";import{R as x,a as h}from"./RowFormGroupSelect-DHTTcsG1.js";import"./Progress-DfFu4aa7.js";const D=({users:n})=>{var d,m;const{data:s,setData:t,post:j,processing:i,errors:o}=g({name:"",user_id:(d=n[0])==null?void 0:d.name,two_gis_id:"",pupr_user_id:(m=n[0])==null?void 0:m.name}),{routes:l}=C().props,[b,p]=v.useState(!1),_=r=>{r.preventDefault(),j(`/${l.backendprefix}/${l.brunch}`+(b?"?redirectOnCreation=true":""))};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Создание филиала"}),e.jsx(w,{}),e.jsxs(N,{children:[e.jsx(y,{children:e.jsx(a,{children:e.jsx("h2",{children:"Cоздание филиала"})})}),e.jsxs(F,{className:"row",onSubmit:_,children:[e.jsxs(a,{className:`
                        border
                        border-primary
                        rounded
                        col-12
