import{x as b,J as f,r as g,j as e}from"./app-i4cspIKJ.js";import{H as w}from"./Head-DwZileCz.js";import{N as v}from"./NavBar-BgNXtu38.js";import{C,R as y,a as n,B as u}from"./Alert-Aabz5wdd.js";import{F as N,a as c}from"./Label-4HL7lDRm.js";import{R as t,a as R}from"./RowFormGroupSelect-6Vtcohlv.js";import{R as _}from"./RowFormGroupWithPrefix-CLfTpvMK.js";import"./Progress-NWnNTZJp.js";import"./FormFeedback-BKvZSbnQ.js";import"./Input-DMHSdn88.js";const H=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:i}=f().props,[m,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${i.backendprefix}/${i.user}`+(m?"?redirectOnCreation=true":"")),m&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
