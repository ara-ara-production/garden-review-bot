import{x as b,J as f,r as g,j as e}from"./app-CCNGmOak.js";import{H as w}from"./Head-w5peUG2M.js";import{N as v}from"./NavBar-muLNc2Y9.js";import{C,R as y}from"./Row-BaC-3dof.js";import{C as n,B as u}from"./Alert-BjESWk9v.js";import{F as N,a as c}from"./Label-cSkGvJvA.js";import{R as t,a as R}from"./RowFormGroupSelect-D8KyBZNn.js";import{R as _}from"./RowFormGroupWithPrefix-BdcNd4hH.js";const D=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:m}=f().props,[i,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${m.backendprefix}/${m.user}`+(i?"?redirectOnCreation=true":"")),i&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        ...
                        pl-0
                        pt-4
                        `,children:e.jsx(c,{children:e.jsx(u,{className:"w-100",type:"submit",value:"Сохранить и создать еще",color:"primary",outline:!0,disabled:l,onClick:()=>p(!0),children:"Сохранить и создать еще"})})})]})]})]})};export{D as default};
