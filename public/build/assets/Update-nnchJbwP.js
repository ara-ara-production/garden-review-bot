import{x,J as _,r as h,j as r}from"./app-BaknNhqj.js";import{H as j}from"./Head-DpxRcjdG.js";import{N as b}from"./NavBar-Dej-FWgs.js";import{C as g,R as f,a as n,B as w}from"./Alert-CONlK0ny.js";import{F as C,a as v}from"./Label-BEoBeC8X.js";import{R as i,a as l}from"./RowFormGroupSelect-B2LOfHeA.js";import"./Progress-DnTE48kW.js";import"./Input-fRWFVZgp.js";const D=({values:s,users:d})=>{const{data:a,setData:t,put:u,processing:m,errors:o}=x({name:s.name??"",user_id:s.user_id??"",two_gis_id:s.two_gis_id??"",pupr_user_id:s.pupr_user_id??"",address:s.address??""}),{routes:p}=_().props,[y,N]=h.useState(!1),c=e=>{e.preventDefault(),u(`/${p.backendprefix}/${p.brunch}/${s.id}`)};return r.jsxs(r.Fragment,{children:[r.jsx(j,{title:"Обновление филиала"}),r.jsx(b,{}),r.jsxs(g,{children:[r.jsx(f,{children:r.jsx(n,{children:r.jsx("h2",{children:"Обновление филиала"})})}),r.jsxs(C,{className:"row",onSubmit:c,children:[r.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
