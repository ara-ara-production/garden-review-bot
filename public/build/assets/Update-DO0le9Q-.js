import{x,J as g,r as c,j as e}from"./app-zhzAyp58.js";import{H as h}from"./Head-ClWKlaNT.js";import{N as j}from"./NavBar--vOhkuN5.js";import{C as b,R as v,a as d,B as y}from"./Alert-Ck5wO5DS.js";import{F as C,a as f}from"./Label-BTOJADJT.js";import{R as t,a as p}from"./RowFormGroupSelect-BxmMqb-u.js";import"./Progress-DVecwT0F.js";import"./Input-D_eEr9ts.js";const D=({values:a,users:i})=>{const{data:o,setData:n,put:u,processing:_,errors:s}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:l}=g().props,[w,N]=c.useState(!1),m=r=>{r.preventDefault(),u(`/${l.backendprefix}/${l.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(v,{children:e.jsx(d,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:m,children:[e.jsxs(d,{className:`
                        border
                        border-primary
                        rounded
                        col-12
