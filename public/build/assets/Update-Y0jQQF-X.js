import{x,J as g,r as c,j as e}from"./app-OylCr9Tv.js";import{H as h}from"./Head-BCdnzafk.js";import{N as j}from"./NavBar-DCWNL8uJ.js";import{C as b,R as y,a as s,B as v}from"./Alert-DJwVXH-o.js";import{F as C,a as f}from"./Label-eOr0Zt6B.js";import{R as d,a as l}from"./RowFormGroupSelect-C7eM6E1d.js";import"./Progress-DfervQBR.js";import"./FormFeedback-EtjYHvFE.js";import"./Input-ByNWNJhS.js";const E=({values:a,users:i})=>{console.log(a);const{data:o,setData:n,put:_,processing:m,errors:t}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",yandex_map_id:a.yandex_map_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:p}=g().props,[w,N]=c.useState(!1),u=r=>{r.preventDefault(),_(`/${p.backendprefix}/${p.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(y,{children:e.jsx(s,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:u,children:[e.jsxs(s,{className:`
                        border
                        border-primary
                        rounded
                        col-12
