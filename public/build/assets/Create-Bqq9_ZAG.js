import{x as g,J as v,r as C,j as e}from"./app-BaknNhqj.js";import{H as f}from"./Head-DpxRcjdG.js";import{N as w}from"./NavBar-Dej-FWgs.js";import{C as y,R as N,a as t,B as c}from"./Alert-CONlK0ny.js";import{F,a as x}from"./Label-BEoBeC8X.js";import{R as i,a as h}from"./RowFormGroupSelect-B2LOfHeA.js";import"./Progress-DnTE48kW.js";import"./Input-fRWFVZgp.js";const D=({users:o})=>{var u,m;const{data:a,setData:s,post:j,processing:l,errors:n}=g({name:"",user_id:(u=o[0])==null?void 0:u.name,two_gis_id:"",pupr_user_id:(m=o[0])==null?void 0:m.name,address:""}),{routes:d}=v().props,[b,p]=C.useState(!1),_=r=>{r.preventDefault(),j(`/${d.backendprefix}/${d.brunch}`+(b?"?redirectOnCreation=true":""))};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Создание филиала"}),e.jsx(w,{}),e.jsxs(y,{children:[e.jsx(N,{children:e.jsx(t,{children:e.jsx("h2",{children:"Cоздание филиала"})})}),e.jsxs(F,{className:"row",onSubmit:_,children:[e.jsxs(t,{className:`
                        border
                        border-primary
                        rounded
                        col-12
