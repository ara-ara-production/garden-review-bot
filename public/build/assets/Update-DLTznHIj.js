import{u as x,a as g,r as c,j as e}from"./app-CZUs4bFv.js";import{H as h}from"./Head-DCKL1LJ9.js";import{N as j}from"./NavBar-D6hSJFqI.js";import{C as b,R as v,a as d,B as y}from"./Alert-oS2A1CcT.js";import{F as C,a as f}from"./Label-B311HVj_.js";import{R as t,a as p}from"./RowFormGroupSelect-DT2VQD0Y.js";import"./Progress-BxdBp0H_.js";import"./Input-D0y16emI.js";const D=({values:a,users:i})=>{const{data:o,setData:n,put:u,processing:m,errors:s}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:l}=g().props,[w,F]=c.useState(!1),_=r=>{r.preventDefault(),u(`/${l.backendprefix}/${l.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(v,{children:e.jsx(d,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:_,children:[e.jsxs(d,{className:`
                        border
                        border-primary
                        rounded
                        col-12
                        ...
                        pl-0
                        pt-4
                        `,children:e.jsx(f,{children:e.jsx(y,{className:"w-100",type:"submit",value:"Обновить",color:"primary",outline:!0,disabled:m,children:"Обновить"})})})]})]})]})};export{D as default};
