import{x,J as g,r as c,j as e}from"./app-BeyQgkzS.js";import{H as h}from"./Head-D79F7KJe.js";import{N as j}from"./NavBar-c9HPES5v.js";import{C as b,R as v,a as d,B as y}from"./Alert-Deh5VzDe.js";import{F as C,a as f}from"./Label-D0yTqglB.js";import{R as s,a as l}from"./RowFormGroupSelect-Bux6HqZ_.js";import"./Progress-DSo4RP_K.js";import"./FormFeedback-3zxxawVB.js";import"./Input-DtNtcSIZ.js";const E=({values:a,users:i})=>{const{data:o,setData:n,put:u,processing:m,errors:t}=x({name:a.name??"",user_id:a.user_id??"",two_gis_id:a.two_gis_id??"",yandex_vendor_id:a.yandex_vendor_id??"",google_map_id:a.google_map_id??"",pupr_user_id:a.pupr_user_id??"",address:a.address??""}),{routes:p}=g().props,[w,N]=c.useState(!1),_=r=>{r.preventDefault(),u(`/${p.backendprefix}/${p.brunch}/${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Обновление филиала"}),e.jsx(j,{}),e.jsxs(b,{children:[e.jsx(v,{children:e.jsx(d,{children:e.jsx("h2",{children:"Обновление филиала"})})}),e.jsxs(C,{className:"row",onSubmit:_,children:[e.jsxs(d,{className:`
                        border
                        border-primary
                        rounded
                        col-12
