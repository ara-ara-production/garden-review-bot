import{x as g,J as C,r as v,j as e}from"./app-Ceilj5gI.js";import{H as f}from"./Head-Fe5SP0jG.js";import{N as w}from"./NavBar-G3_c6S1r.js";import{C as N,R as y,a,B as u}from"./Alert-D3wkYAE_.js";import{F,a as c}from"./Label-BgYYvHz8.js";import{R as x,a as h}from"./RowFormGroupSelect-yyk8inSP.js";import"./Progress-BxRV9Kmm.js";const D=({users:n})=>{var d,m;const{data:s,setData:t,post:j,processing:i,errors:o}=g({name:"",user_id:(d=n[0])==null?void 0:d.name,two_gis_id:"",pupr_user_id:(m=n[0])==null?void 0:m.name}),{routes:l}=C().props,[b,p]=v.useState(!1),_=r=>{r.preventDefault(),j(`/${l.backendprefix}/${l.brunch}`+(b?"?redirectOnCreation=true":""))};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Создание филиала"}),e.jsx(w,{}),e.jsxs(N,{children:[e.jsx(y,{children:e.jsx(a,{children:e.jsx("h2",{children:"Cоздание филиала"})})}),e.jsxs(F,{className:"row",onSubmit:_,children:[e.jsxs(a,{className:`
                        border
                        border-primary
                        rounded
                        col-12
