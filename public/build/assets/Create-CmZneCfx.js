import{x as b,J as f,r as g,j as e}from"./app-CC8VcOoO.js";import{H as w}from"./Head-BtZCk6c9.js";import{N as v}from"./NavBar-CAU1Y158.js";import{C,R as y,a as n,B as u}from"./Alert-BnXz6e0s.js";import{F as N,a as c}from"./Label-CQDe2Bsx.js";import{R as t,a as R}from"./RowFormGroupSelect-CfIfWvX6.js";import{R as _}from"./RowFormGroupWithPrefix-C4xIsAL8.js";import"./Progress-CVZbZEGv.js";import"./Input-DuYs5T8-.js";const E=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:i}=f().props,[m,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${i.backendprefix}/${i.user}`+(m?"?redirectOnCreation=true":"")),m&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
