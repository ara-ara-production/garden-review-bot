import{x as b,J as f,r as g,j as e}from"./app-OylCr9Tv.js";import{H as w}from"./Head-BCdnzafk.js";import{N as v}from"./NavBar-DCWNL8uJ.js";import{C,R as y,a as n,B as u}from"./Alert-DJwVXH-o.js";import{F as N,a as c}from"./Label-eOr0Zt6B.js";import{R as t,a as R}from"./RowFormGroupSelect-C7eM6E1d.js";import{R as _}from"./RowFormGroupWithPrefix-DBMCnZ_Q.js";import"./Progress-DfervQBR.js";import"./FormFeedback-EtjYHvFE.js";import"./Input-ByNWNJhS.js";const H=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:i}=f().props,[m,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${i.backendprefix}/${i.user}`+(m?"?redirectOnCreation=true":"")),m&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
