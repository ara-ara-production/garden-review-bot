import{x as b,J as f,r as g,j as e}from"./app-CS2DxlMB.js";import{H as w}from"./Head-DRp1B5zj.js";import{N as v}from"./NavBar-DSX2ZGb4.js";import{C,R as y,a as n,B as u}from"./Alert-BFTpQm7k.js";import{F as N,a as c}from"./Label-Dipvz61S.js";import{R as t,a as R}from"./RowFormGroupSelect-C50sIDC9.js";import{R as _}from"./RowFormGroupWithPrefix-D8G9wyVw.js";import"./Progress-DRNyzWk8.js";import"./Input-jVefjrW8.js";const E=({roles:d})=>{const{data:a,setData:s,post:x,processing:l,errors:o,reset:h}=b({name:"",telegram_username:"",email:"",password:"",password_confirmation:"",role:"NullRole"}),{routes:i}=f().props,[m,p]=g.useState(!1),j=r=>{r.preventDefault(),x(`/${i.backendprefix}/${i.user}`+(m?"?redirectOnCreation=true":"")),m&&h()};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Создание пользователя"}),e.jsx(v,{}),e.jsxs(C,{children:[e.jsx(y,{children:e.jsx(n,{children:e.jsx("h2",{children:"Cоздание пользователя"})})}),e.jsxs(N,{className:"row",onSubmit:j,children:[e.jsxs(n,{className:`
                        border
                        border-primary
                        rounded
                        col-12
